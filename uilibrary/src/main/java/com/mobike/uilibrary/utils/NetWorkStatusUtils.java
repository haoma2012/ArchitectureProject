...
/**
 * 网络判断
 * Created by yangdehao@xiaoyouzi.com  on 2019/4/12 上午10:11
 */
public class NetWorkStatusUtils {
    ...
    public static boolean queryNetWork(final Context ctx) {
        ...
        try {
            boolean bConnection = NetWorkStatusUtils.getNetworkConnectionStatus(ctx);
    ...
    public static boolean isSupportNetWork(final Context ctx) {
        ...
        try {
            boolean bCMWap = NetWorkStatusUtils.isCMWap(ctx);
            boolean b3GWAP = NetWorkStatusUtils.is3GWAP(ctx);
            boolean bCTWap = NetWorkStatusUtils.isCTWap(ctx);
            boolean bUNIWap = NetWorkStatusUtils.isUNIWap(ctx);
