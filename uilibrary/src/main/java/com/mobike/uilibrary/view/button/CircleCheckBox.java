package com.mobike.uilibrary.view.button;
...
/**
 * Created by yangdehao@xiaoyouzi.com  on 2019/4/8 下午8:54
 */
public class CircleCheckBox extends MaterialCheckBox {
    ...
    private void getAttrs(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mTickColor = a.getColor(R.styleable.CircleCheckBox_tick_color, Color.WHITE);
            mTickWidth = a.getDimensionPixelSize(R.styleable.CircleCheckBox_tick_width, UNSET_FLAG);
            mBorderWidth = a.getDimensionPixelOffset(R.styleable.CircleCheckBox_border_width, UNSET_FLAG);
            mBorderColor = a.getColor(R.styleable.CircleCheckBox_border_color, Color.parseColor("#4AC65A"));
